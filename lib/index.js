...
module.exports = class NumbersStation {
   ...
   */
  static getNumber (maximum) {
    return getNumber(0, maximum)
  }
   ...
   */
  constructor (maximum = Number.MAX_SAFE_INTEGER, interval = NumbersStation.DEFAULT_INTERVAL) {
   ...
   */
  getNumber () {
    return NumbersStation.getNumber(this.maximum)
  }
  ...
  listen (port, cb) {
    ...
    if (!port) {
      port = NumbersStation.DEFAULT_PORT
